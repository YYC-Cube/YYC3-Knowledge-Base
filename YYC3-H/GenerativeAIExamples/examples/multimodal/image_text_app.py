...
class MultimodalApp:
    ...
    def analyze_image(self, image: Image.Image, query: Optional[str] = None) -> Dict[str, Any]:
...
def create_gradio_interface():
    ...
    def process_image(image, query):
        ...
        try:
            ...
            output += f"**Size:** {results['size'][0]} x {results['size'][1]} pixels\n\n"
    ...
    interface = gr.Interface(
        ...
        inputs=[
            ...
            gr.Textbox(label="Optional: Text Query", placeholder="Describe what you're looking for...")
        ],
