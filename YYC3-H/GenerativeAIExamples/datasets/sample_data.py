    ...
    documents = [
        {
            ...
            """,
            "category": "basics",
            "tags": ["machine learning", "AI", "algorithms", "supervised", "unsupervised"]
        },
        {
        ...
        },
        {
            ...
            "tags": ["NLP", "language processing", "BERT", "GPT", "transformers", "text analysis"]
        },
        {
            ...
            """,
            "category": "applications",
            "tags": ["computer vision", "CNN", "image classification", "object detection", "ResNet"]
        },
        {
            ...
            """,
            "category": "advanced",
            "tags": ["reinforcement learning", "Q-learning", "policy gradients", "AlphaGo", "robotics"]
        },
        {
            ...
            """,
            "category": "emerging",
            "tags": ["generative AI", "LLM", "GPT", "ChatGPT", "transformers", "content creation"]
        }
    ]
...
def save_sample_data():
    ...
    with open(os.path.join(datasets_dir, "ai_documents.json"), "w", encoding="utf-8") as f:
    ...
    sentiment_data = [{"text": text, "label": label} for text, label in zip(texts, labels)]
    with open(os.path.join(datasets_dir, "sentiment_data.json"), "w", encoding="utf-8") as f:
    ...
    with open(os.path.join(datasets_dir, "multimodal_data.json"), "w", encoding="utf-8") as f:
