/**
 * YYC3 Cyber Editor — Monaco Editor wrapper with cyberpunk theme,
 *   collaborative cursors, and diff-aware preview integration
 * @version 4.8.0
 */
...
export const CyberEditor = forwardRef<CyberEditorHandle, CyberEditorProps>(function CyberEditor(
  ...
  }, [remoteUsers, editorReady, collab.operations])
