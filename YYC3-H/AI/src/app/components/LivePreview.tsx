/**
 * YYC³ Live Preview — Real-time code preview with sandbox, device emulation,
 *   console capture, history navigation, and scroll sync
 * @description Supports HTML, CSS, JS, React (JSX/TSX), Markdown, SVG preview
 * @version 4.8.0
 */
