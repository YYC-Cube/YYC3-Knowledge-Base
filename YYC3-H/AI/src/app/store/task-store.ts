/**
 * @file task-store.ts
 * @description YYC3 Task Store — Kanban 任务管理 + AI 任务推理 + 子任务 + 依赖 + 提醒
 ...
 * @status stable
 * @license MIT
 * @tags store,task,kanban,ai-inference,reminders
 *
 * 对齐 Guidelines: P1-AI-task-board — TaskInference / TaskManager / TaskReminder / TaskDependencies
 */
