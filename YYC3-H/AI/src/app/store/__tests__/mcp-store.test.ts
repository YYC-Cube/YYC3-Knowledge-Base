/**
 * YYC3 MCP Store — Unit Tests
 * @description 验证 MCP Server CRUD、健康检查、工具发现、工具调用、Claude Desktop JSON 导入导出
 * @version 4.8.0
 * 对齐 Guidelines: AI Service Integration — MCP Tools
 */
...
import { mcpStoreActions, mcpStore } from '../mcp-store'
