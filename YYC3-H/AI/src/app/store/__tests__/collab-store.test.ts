/**
 * YYC3 Collab Store — Unit Tests
 * @description 验证协作编辑状态管理：用户列表、操作推送、OT 变换、冲突检测/解决、模拟循环
 * @version 4.8.0
 * 对齐 Guidelines: Real-time Collaboration — yjs/CRDT/OT
 */
import { describe, it, expect, beforeEach, vi, afterEach } from 'vitest'

vi.useFakeTimers()

import { collabStore, type CollabUser, type CRDTOperation, type ConflictRecord } from '../collab-store'
