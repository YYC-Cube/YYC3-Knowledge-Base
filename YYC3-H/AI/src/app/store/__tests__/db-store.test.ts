/**
 * YYC3 DB Store — Unit Tests
 * @description 验证引擎发现、连接管理、Schema/表/列浏览、查询执行、备份记录、面板切换
 * @version 4.8.0
 * 对齐 Guidelines: Local-Database Manager
 */
...
import { dbStoreActions, dbStore } from '../db-store'
