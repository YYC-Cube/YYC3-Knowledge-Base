/**
 * YYC3 Model Store — Unit Tests
 * @description 验证 AI 模型 CRUD、激活/停用、localStorage 持久化、缓存、速率限制、fallback 逻辑
 * @version 4.8.0
 * 对齐 Guidelines: AI Service Integration — Multi-Provider, Caching, Rate Limiting
 *
 * NOTE: model-store 使用 React Context + useState，非 useSyncExternalStore。
 * 单元测试直接验证底层 localStorage helpers 和工具函数。
 */
