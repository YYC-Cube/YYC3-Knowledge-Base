/**
 * YYC3 Crypto Store — Unit Tests
 * @description 验证保险库状态、审计日志、加密/解密（含 Web Crypto API）、Vault 键值存储、设置
 * @version 4.8.0
 * 对齐 Guidelines: Security & Privacy — AES-GCM encryption, PBKDF2 key derivation
 */
