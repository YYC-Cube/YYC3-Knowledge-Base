/**
 * YYC3 File Store — Unit Tests
 * @description 验证版本控制、最近文件、操作日志、diff 工具、面板可见性
 * @version 4.8.0
 * 对齐 Guidelines: Host-File-System Manager — file version control
 */
...
describe('Recent Files', () => {
  ...
  it('recordAccess should add a file to recent list', () => {
    ...
    const recent = fileStoreActions.getOperations(0) // use state directly via hook
