/**
 * YYC3 Project Store — Unit Tests
 * @description 验证项目模板、创建流程、状态机步骤、模态框开关、项目 CRUD
 * @version 4.8.0
 * 对齐 Guidelines: Core Mission — Design as Code, Configuration as Deployment
 */
import { describe, it, expect, beforeEach, vi, afterEach } from 'vitest'

vi.useFakeTimers()

import { projectStore, PROJECT_TEMPLATES, type ProjectTemplate, type ProjectInfo, type CreationStep } from '../project-store'
