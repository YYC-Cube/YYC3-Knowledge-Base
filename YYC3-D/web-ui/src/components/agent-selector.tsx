...
export function AgentSelector(): JSX.Element {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement('option', { value: '' }, '选择智能体'),
      agents.map((agent) =>
        React.createElement(
          'option',
    ...
    selectedAgent &&
      React.createElement(
        'div',
        { className: 'yyc3-agent-info' },
        React.createElement('h4', null, selectedAgent.name),
        React.createElement('p', null, selectedAgent.role),
        React.createElement(
          'div',
          { className: 'yyc3-agent-capabilities' },
