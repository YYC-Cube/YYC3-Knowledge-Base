...
def invocation_deprecation_warning(func):
    """Print a deprecation warning for the invocation related functions."""

    @functools.wraps(func)
    def new_func(*args, **kwargs):
        warnings.simplefilter("always", PendingDeprecationWarning)
        warnings.warn(
            f"{func.__name__} is pending deprecation, please refer to NVCF docs.",
