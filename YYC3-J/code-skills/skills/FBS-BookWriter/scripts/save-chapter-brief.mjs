...
if (import.meta.url === `file://${process.argv[1]}`) {
  ...
  // 示例Brief数据
  const exampleBrief = {
    objective: '本章考证杜氏家族的起源,包括早期历史记载、迁徙路线、分支形成等。',
    sections: [
      { number: '1.1', title: '起源考证', description: '考证杜氏家族的起源,包括历史记载和考古发现' },
      { number: '1.2', title: '迁徙路线', description: '梳理杜氏家族的迁徙路线和分布情况' },
      { number: '1.3', title: '分支形成', description: '分析杜氏家族各分支的形成过程' }
    ],
    evidence: [
      '《左传》中的杜氏记载',
      '《史记》中的杜氏记载',
