...
> **说明**：本文件保留叙事化阶段规范。多 Agent 协作由宿主按 `SKILL.md` 与 `references/05-ops/heartbeat-protocol.md` 执行。

---

## §1 协作角色与工作流映射

> 与 [`persona.md`](./persona.md)、[`05-ops/brand-outputs.md`](./05-ops/brand-outputs.md) 一致：对外使用**岗位与产品叙事**，不使用历史或虚构人名。
