...
See [references/design-decisions.md](references/design-decisions.md) for the rationale behind key design choices (post-completion timing, simplify-first ordering, budget constraints, pass separation, and the document micro-pass).
