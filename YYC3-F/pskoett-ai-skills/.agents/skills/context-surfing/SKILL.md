...
- **Standalone:** the user's original task description + project context files (AGENTS.md, AGENTS.md, README.md, etc.)
...
- `AGENTS.md` — agent configuration, conventions, constraints
