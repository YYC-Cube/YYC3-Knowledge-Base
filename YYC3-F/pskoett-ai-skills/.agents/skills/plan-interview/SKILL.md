...
Codex: I'll help you plan the OAuth authentication feature. Let me gather
        requirements first.
...
Codex: [Explores codebase for auth patterns, session handling, database schema]

Codex: [Writes docs/plans/plan-003-oauth-authentication.md]
...
Codex: [Auto-starts implementation with TodoWrite tracking]
```
